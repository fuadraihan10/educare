...
export default async function TeacherAnnouncementsPage() {
  ...
  const announcements = await listAnnouncementsForRole('TEACHER', user.id)
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      {announcements.length === 0 ? (
        <EmptyState icon={Megaphone} title="No announcements" description="There are no announcements at this time." />
      ) : (
